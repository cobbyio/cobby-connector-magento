 ...
 */
class Cobby_Connector_Model_Import_Product_Api extends Mage_Api_Model_Resource_Abstract
{
    const START = 'start';
    const FINISH = 'finish';
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_category');
    ...
    public function importProducts($data, $typeModels, $usedSkus, $transactionId)
    {
        ...
        $importModel = Mage::getModel('cobby_connector/import_entity_product',
        ...
        $arrayAdapter = Mage::getModel('cobby_connector/arrayAdapter', $transportObject->getRows());
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_grouped');
        $result = $model->import($data);
        return $result;
    }
    ...
    public function updateConfigurableProducts($data)
    {
        ...
        $model = Mage::getModel('cobby_connector/import_product_configurable');
        $result = $model->import($data);
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_media');
        $result = $model->import($data);
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_stock');
        $result = $model->import($data);
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_link');
        $result = $model->import($data);
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_tierprice');
        $result = $model->import($data);
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_groupprice');
        $result = $model->import($data);
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_url');
        $result = $model->import($data);
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_customoption');
        $result = $model->import($data);
    ...
    {
        $model = Mage::getModel('cobby_connector/import_product_bundleoption');
        $result = $model->import($data);
